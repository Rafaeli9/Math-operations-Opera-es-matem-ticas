...
var resultado = "Qual a divisão de: " + numero1 + " / " + numero2 + " ?";
...
function conferirDivi() {  
    ...
    if (conf == soma){        
        ...
        //   btnChange.addEventListener('click', () => btnChange.style.backgroundColor='red',
        //   btnChange2.style.backgroundColor='#ee1d52',
        //   btnChangeOne.style.backgroundColor='green')       
    }else if (conf == "") {            
        Swal.fire({
            title: 'ERROOO!!!',
